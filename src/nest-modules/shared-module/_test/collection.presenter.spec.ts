...
class StubCollectionPresenter extends CollectionPresenter { //Como nao cnosegue inanciar a classe de collection, se cria o stub da classe para conseguir testar.
    data = [1, 2, 3];
}
...
describe('CollectionPresenter Unit Tests', () => {
    ...
    it('should presenter data', () => {
        ...
        //InstanceToPlain -> traz o objeto puro como objeto js.
