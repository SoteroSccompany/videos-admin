...
export class CategoryFakeBuilder<TBuild = any> {
    ...
    static fake() {
        return CategoryFakeBuilder; //Poderia usar o this, mas caso tenha uma subclasse, pode sobrescrever. Por isso e pela semantica, e melhor usar o nome da classe
    }
